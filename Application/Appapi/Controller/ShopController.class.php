...
class ShopController extends Controller {
    ...
    public function testrun(){
        echo httpPost("http://backlogic/index.php/Appapi/Shop/get_topshop",array("id"=>1));
    }
     //添加店铺
...
//查找店铺
    ...
    public  function get_topshop()
    {
        $ystoken=I('post.ystoken');
        $data=ShopModel::get_topshop($ystoken);
        return_json($data);
    }
